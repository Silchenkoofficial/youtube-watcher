...
const API_KEY = "AIzaSyDI1PdphjoZjJITEiibMSEk7vk_ZM_3qr8";
...
const showVideo = () => {
  $.ajax({
    dataType: "json",
    type: "GET",
    url: `https://www.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&id=${getVideoID()}&key=${API_KEY}`,
    success: (data) => {
      data = data.items[0];
...
const loadRelatedVideos = () => {
  $.ajax({
    dataType: "json",
    type: "GET",
    url: `https://www.googleapis.com/youtube/v3/search?part=snippet&relatedToVideoId=${getVideoID()}&type=video&key=${API_KEY}`,
    success: (data) => {
      data.items
